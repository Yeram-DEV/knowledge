...
export default function NotFound() {
  return (
    <div className="relative w-full h-[100dvh] flex flex-col items-center justify-center gap-8 bg-baron-pattern bg-no-repeat bg-cover bg-top">
      ...
      <div className="w-full flex flex-col items-center justify-center">
        ...
        <span>올바른 주소인지 확인 후 다시 시도해 주세요.</span>
      </div>
