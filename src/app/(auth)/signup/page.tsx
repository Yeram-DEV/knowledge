        ...
        >
          ...
          <CardBody className="w-full flex flex-col items-center justify-center gap-4">
            <form action={createMeta} className="w-full flex flex-col items-center justify-center gap-4">
              <Input type="text" name="fullName" label="이름" defaultValue={user.user_metadata.name} />
              <select
                name="team"
                className="appearance-none w-full min-h-10 h-14 px-3 py-2 text-foreground-500 rounded-medium bg-default-100"
              >
