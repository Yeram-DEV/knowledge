  ...
  return (
    <div className="w-full !max-w-full flex flex-col items-center justify-center p-8 prose bg-white">
      <div className="max-w-[1140px] flex flex-col items-start justify-center">
        ...
        <span>
          회사명(이하 지식센터라 한다)는 개인정보 보호법 제30조에 따라 정보 주체의 개인정보를 보호하고 이와 관련한
        ...
        <span>
          ...
          따른 본인확인, 서비스 부정 이용 방지, 만 14세 미만 아동의 개인정보처리 시 법정대리인의 동의 여부 확인, 각종
        ...
        <h2>제3조(이용자 및 법정대리인의 권리와 그 행사 방법)</h2>
        ...
        <span>4. 처리정지 요구</span>
        <span>
          ② 제1항에 따른 권리 행사는 회사에 대해 서면, 전화, 전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며 회사는
          이에 대해 지체없이 조치하겠습니다.
        </span>
        <span>
        ...
        <span>3. 인터넷 서비스 이용과정에서 아래 개인정보 항목이 자동으로 생성되어 수집될 수 있습니다.</span>
        ...
        <span>2. 기술적 조치 : 개인정보처리시스템 등의 접근 권한 관리, 접근통제시스템 설치, 고유 식별정보</span>
        <span>등의 암호화, 보안프로그램 설치</span>
        <span>3. 물리적 조치 : 전산실, 자료보관실 등의 접근통제</span>

        <h2>제6조(개인정보 자동 수집 장치의 설치∙운영 및 거부에 관한 사항)</h2>
        <span>
        ...
        <span>▶ 경찰청 사이버안전국 : 182 (https://cyberbureau.police.go.kr)</span>
        <span>제13조(개인정보 처리방침 시행 및 변경)</span>
        <span>이 개인정보 처리방침은 2024. 08. 05부터 적용됩니다.</span>
      </div>
    </div>
  )
}
